...
def usage():
	...
	print (''' \033[92m	Palestine DDos Script by TEAM PALESTINE DDOS

	You Joined To Ddos!!.

	Gunakan Untuk Menyerang Website Israel. \n

	Gunakan : python3 palestineddos.py [-s] [-p] [-t]
...
def get_parameters():
	...
	optp = OptionParser(add_help_option=False,epilog="PalestineDdos")
